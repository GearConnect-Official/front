...
import { FeedbackType } from '../../src/components/FeedbackMessage';
import { ApiError, ErrorType } from '../../src/services/axiosConfig';
import * as axiosConfig from '../../src/services/axiosConfig';

jest.mock('../../src/services/axiosConfig', () => {
  const original = jest.requireActual('../../src/services/axiosConfig');
  return {
    ...original,
