// This file is auto-generated from termsAndConditions.yaml
// To update, modify the YAML file and run: npm run build:content
// Or manually update this file

import { TermsData } from '../utils/yamlLoader';
